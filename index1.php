...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                ...
                <h1 class="sitename text-black">Bank Sampah</h1>
            </a>
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                        ...
                        <div class="d-flex">
                            <a href="#about" class="btn-get-started" style="margin-right: 5px;">Daftar Sekarang</a>
                            <a href="#about" class="btn-get-started">Login Sekarang</a>
        ...
        <section id="services" class="services section light-background">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Alur Penyetoran Sampah</h2>
                <!-- <p>Necessitatibus eius consequatur ex aliquid fuga eum quidem sint consectetur velit</p> -->
            </div><!-- End Section Title -->

            <div class="container">
                <div class="row gy-4">
                    <div class="col-xl-3 col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative" style="background-color: #83B40F;">
                            <div class="service-icon">
                                <img src="img/garbage.png" alt="Card Image">
                            </div>
                        </div>
                        <h4 style="font-size: 18px; text-align: center; margin-top: 20px;">Pemilahan Sampah</h4>
                    </div>

                    <div class="col-xl-3 col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative" style="background-color: #83B40F;">
                            <div class="service-icon">
                                <img src="img/clock.png" alt="Card Image">
                            </div>
                        </div>
                        <h4 style="font-size: 18px; text-align: center; margin-top: 20px;">Penyetoran ke Bank Sampah</h4>
                    </div>

                    <div class="col-xl-3 col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative" style="background-color: #83B40F;">
                            <div class="service-icon">
                                <img src="img/control.png" alt="Card Image">
                            </div>
                        </div>
                        <h4 style="font-size: 18px; text-align: center; margin-top: 20px;">Penimbangan dan Pencacatan <br> Jumlah Sampah</h4>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h4 style="font-size: 18px; text-align: center; margin-top: 20px;">Penerbitan Invoice Hasil Tabungan Sampah</h4>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script src="view/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
