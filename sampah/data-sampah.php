                ...
                <div class="container-xxl" style="padding-top: 20px;">
                    ...
                    <div class="container">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-sampah.php?id_sampah=<?php echo $data['id_sampah']; ?>" class="btn btn-warning" role="button">Edit</a>
                                            <a href="data-sampah.php?delete_id=<?php echo $data['id_sampah']; ?>" class="btn btn-danger" role="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php
                        ...
                        if (isset($_GET['delete_id'])) {
                            $id_sampah = htmlspecialchars($_GET['delete_id']);
                            $sql = "DELETE FROM sampah WHERE id_sampah='$id_sampah'";
                            $hasil = mysqli_query($koneksi, $sql);

                            if ($hasil) {
                                echo "<script>alert('Data berhasil dihapus');window.location='data-sampah.php';</script>";
                            } else {
                                echo "<div class='alert alert-danger'> Data gagal dihapus.</div>";
                            }
                        }
                        ?>
                        <a href="tambah-sampah.php" class="btn btn-success" style="margin-top: -15px;">Tambah Data</a>
                    </div>
