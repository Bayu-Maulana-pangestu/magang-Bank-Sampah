...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Bulan Mei 2024 pada 13.53
...
INSERT INTO `user` (`login-id`, `username`, `password`) VALUES
...
--
ALTER TABLE `user`
  MODIFY `login-id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
